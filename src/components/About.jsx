...
const About = () => {
  ...
  useEffect(() => {
     ...
     // Watches the About section and detects when it enters the screen
    ...
    // Check if the About section was successfully connected to the ref
    if (aboutRef.current) {
    ...
    ref={aboutRef}
     id='about'
      ...
      <div className='mx-auto grid max-w-7xl px-4 gap-16 sm:px-6 lg:px-12 lg:grid-cols-2 lg:gap-20'>
        ...
        {/* Image container with a subtle entrance animation */}
        <div className={`relative  ${isVisible ? 'about-image-reveal' : ''}`}>

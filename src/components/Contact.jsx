                    ...
                    <div className='rounded-2xl bg-[#F8F5EF] p-6 dark:bg-gray-900 sm:p-8'>
                        ...
                        <div className='mt-6 flex items-start gap-4'>
                            ...
                            <div className='mt-6 flex items-center gap-3'>
                                ...
                                {/* Instagram */}
                                <a
                                    href="https://www.instagram.com/zavoraevents/"
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    aria-label='Visit Zavora on Instagram'
                                    className='flex h-10 w-10  items-center justify-center rounded-full bg-[#E1306C]/10 transition-all duration-300 hover:-translate-y-1 hover:bg-[#E1306C]/20'>
                                    <FaInstagram size={19}
                                        color='#E1306C'
                                        aria-hidden='true' />
                                </a>
                                ...
                                <a
                                    href="https://wa.me/2348123964378"
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    aria-label='Chat with Zavora on WhatsApp'
                                    className='flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366]/10 transition-all duration-300 hover:-translate-y-1 hover:bg-[#25D366]/20'>
                                    <FaWhatsapp size={19}
                                        color='#25D366'
                                        aria-hidden='true' />
                                </a>
